...
options = {
  ...
  xaxis: {
    categories: ['9/1', '9/2', '9/2', '9/10', '9/10', '9/11', '9/12'],
    title: { text: '' },
  },
  yaxis: {
    title: { text: '' },
...
(dataColors = $('#line-chart-datalabel1').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 170,
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-datalabel1'),
  options
)).render();

(dataColors = $('#line-chart-datalabel2').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 524,
  ...
  series: [
    {
      name: '혈당 ',
      data: [
        23, 42, 35, 27, 43, 22, 17, 31, 22, 22, 23, 42, 35, 27, 43, 22, 17, 31,
        22, 22, 23, 42, 35, 27, 43, 22, 17, 31, 22, 22, 23, 42, 35, 27, 43, 22,
        17, 31, 22, 22, 23, 42, 35, 27, 43, 22, 17, 31, 22, 22, 23, 42, 35, 27,
        43, 22, 17, 31, 22, 22, 23, 42, 35, 27, 43, 22, 17, 31, 22, 22, 23, 42,
        35, 27, 43, 22, 17, 31, 22, 22, 23, 42, 35, 27, 43, 22, 17, 31, 22, 22,
      ],
    },
  ],
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-datalabel2'),
  options
)).render();
...
var options = {
    ...
    series: [
      { name: '식사', data: [4012, 1900, 3248, 4370, 2440, 3280, 4690] },
    ],
    colors: colors,
      ...
      y: {
        formatter: function (e) {
          return (
            '<div> ' +
            e +
            'kcal</div><div> - 탄수화물 : 153g (59%)</div><div> - 지방 : 26g (26%)</div><div> - 나트륨 : 13g (13%)</div>'
          );
        },
      },
      style: {
...
(dataColors = $('#bar-chart-exercise').data('colors')) &&
  (colors = dataColors.split(','));
options = {
...
(chart = new ApexCharts(
  document.querySelector('#bar-chart-exercise'),
  options
)).render();
var colors = ['#39afd1'],
...
var options = {
    ...
    series: [
      {
        name: '걸음',
        data: [9512, 4600, 8648, 5470, 4240, 2880, 5490, 7240, 9280, 6490],
      },
    ],
    colors: colors,
    xaxis: {
...
if ($('#insullin-chart-empty').length > 0) {
  ...
  var emptyOptions = {
      chart: { height: 170, type: 'bar', toolbar: { show: !0, offsetX: 10 } },
      plotOptions: {
        bar: { horizontal: !1, endingShape: 'rounded', columnWidth: '33%' },
      },
      dataLabels: { enabled: !1 },
    ...
    chart = new ApexCharts(
      document.querySelector('#insullin-chart-empty'),
      emptyOptions
    );
  chart.render();
}
    ...
    series: [
      {
        name: '고강도',
        data: [
          44, 55, 41, 67, 22, 43, 50, 55, 41, 67, 44, 55, 41, 67, 22, 43, 50,
          55, 41, 67, 44, 55, 41, 67, 22, 43, 50, 55, 41, 67, 44, 55, 41, 67,
          22, 43, 50, 55, 41, 67, 44, 55, 41, 67, 22, 43, 50, 55, 41, 67, 44,
          55, 41, 67, 22, 43, 50, 55, 41, 67, 44, 55, 41, 67, 22, 43, 50, 55,
          41, 67, 44, 55, 41, 67, 22, 43, 50, 55, 41, 67, 44, 55, 41, 67, 22,
          43, 50, 55, 41, 67,
        ],
      },
      {
        name: '중강도',
        data: [
          13, 23, 20, 8, 13, 27, 60, 23, 20, 8, 13, 23, 20, 8, 13, 27, 60, 23,
          20, 8, 13, 23, 20, 8, 13, 27, 60, 23, 20, 8, 13, 23, 20, 8, 13, 27,
          60, 23, 20, 8, 13, 23, 20, 8, 13, 27, 60, 23, 20, 8, 13, 23, 20, 8,
          13, 27, 60, 23, 20, 8, 13, 23, 20, 8, 13, 27, 60, 23, 20, 8, 13, 23,
          20, 8, 13, 27, 60, 23, 20, 8, 13, 23, 20, 8, 13, 27, 60, 23, 20, 8,
        ],
      },
      {
        name: '저강도',
        data: [
          11, 17, 15, 15, 21, 14, 40, 17, 15, 15, 11, 17, 15, 15, 21, 14, 40,
          17, 15, 15, 11, 17, 15, 15, 21, 14, 40, 17, 15, 15, 11, 17, 15, 15,
          21, 14, 40, 17, 15, 15, 11, 17, 15, 15, 21, 14, 40, 17, 15, 15, 11,
          17, 15, 15, 21, 14, 40, 17, 15, 15, 11, 17, 15, 15, 21, 14, 40, 17,
          15, 15, 11, 17, 15, 15, 21, 14, 40, 17, 15, 15, 11, 17, 15, 15, 21,
          14, 40, 17, 15, 15,
        ],
      },
    ],
...
if ($('#basic-column1-empty').length > 0) {
  ...
  var options = {
    ...
    chart = new ApexCharts(
      document.querySelector('#basic-column1-empty'),
      options
    );
  chart.render();
}

(dataColors = $('#line-chart-01').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 148,
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-01'),
  options
)).render();

(dataColors = $('#line-chart-02').data('colors')) &&
  (colors = dataColors.split(','));
var optionsline2 = {
    chart: {
      type: 'line',
  ...
  chartline2 = new ApexCharts(
    document.querySelector('#line-chart-02'),
    optionsline2
  );
chartline2.render();

(dataColors = $('#line-chart-03').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 148,
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-03'),
  options
)).render();

(dataColors = $('#line-chart-04').data('colors')) &&
  (colors = dataColors.split(','));
var optionsline2 = {
    chart: {
      type: 'line',
  ...
  chartline2 = new ApexCharts(
    document.querySelector('#line-chart-04'),
    optionsline2
  );
chartline2.render();

(dataColors = $('#line-chart-11').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 270,
    ...
    y: {
      formatter: function (e) {
        return (
          '<div>10:12</div><div>' +
          e +
          'mg/dL</div> <div>직접입력</div><div>어제 과음함</div>'
        );
      },
    },
    style: {
...
(dataColors = $('#line-chart-12').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 270,
    ...
    y: {
      formatter: function (e) {
        return (
          '<div>10:12</div><div> ' +
          e +
          'mg/dL</div> <div>직접입력</div><div>식사를 거름</div><div>어제 과음함</div>'
        );
      },
    },
    style: {
...
(dataColors = $('#line-chart-p1').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 270,
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-p1'),
  options
)).render();
    ...
    series: [
      {
        name: '저혈압',
        data: [
          66, 44, 55, 57, 56, 61, 58, 63, 60, 44, 55, 57, 56, 57, 56, 57, 56,
          61, 58, 63, 60, 46,
        ],
      },
      {
        name: '고혈압',
        data: [
          94, 76, 85, 101, 98, 87, 105, 91, 114, 94, 76, 85, 101, 98, 87, 114,
          94, 76, 85, 101, 98, 87,
        ],
      },
    ],
...
(dataColors = $('#line-chart-weight').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 380,
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-weight'),
  options
)).render();

(dataColors = $('#line-chart-temperature').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 380,
  ...
  markers: { style: 'inverted', size: 6 },
  xaxis: {
    categories: ['15', '16', '17', '18', '19', '21', '22'],
    title: { text: '' },
  },
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-temperature'),
  options
)).render();

(dataColors = $('#line-chart-wc').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  chart: {
    height: 380,
...
(chart = new ApexCharts(
  document.querySelector('#line-chart-wc'),
  options
)).render();
        ...
        formatter: function (e, a) {
          if (a.seriesIndex === 0) {
            return (
              '<div> ' +
              e +
              'kcal</div><div> - 탄수화물 : 153g (59%)</div><div> - 단백질 : 25g (26%)</div> <div> - 지방 : 13g (25%)</div>'
            );
          }
        },
      },
  ...
  dataLabels: {
    ...
    formatter: function (val, opt) {
      return [
        ...
        opt.w.globals.initialSeries[opt.seriesIndex] + 'Kcal',
        '(' + val.toFixed(0) + '%)',
      ];
    },
  },
...
(chart = new ApexCharts(
  document.querySelector('#donut-chart-meal01'),
  options
)).render();
...
var options = {
  ...
  dataLabels: {
    ...
    formatter: function (val, opt) {
      return [
        opt.w.globals.labels[opt.seriesIndex] + ':',
        opt.w.globals.initialSeries[opt.seriesIndex] + '일',
        '(' + val.toFixed(0) + '%)',
      ];
    },
  },
...
(chart = new ApexCharts(
  document.querySelector('#donut-chart-stress01'),
  options
)).render();
...
(chart = new ApexCharts(
  document.querySelector('#donut-chart-activity01'),
  options
)).render();
...
(chart = new ApexCharts(
  document.querySelector('#donut-chart-meal02'),
  options
)).render();
...
var options = {
    ...
    yaxis: [
      { title: { text: '걸음수' } },
      { opposite: !0, title: { text: '소비 칼로리' } },
    ],
    legend: { offsetY: 7 },
    grid: { borderColor: '#f1f3fa', padding: { bottom: 5 } },
  },
  chart = new ApexCharts(
    document.querySelector('#line-chart-walking'),
    options
  );
chart.render();
...
(chart = new ApexCharts(
  document.querySelector('#insullin-detail-chart'),
  options
)).render();
...
(chart = new ApexCharts(
  document.querySelector('#exercise-video-detail-chart'),
  options
)).render();

colors = ['#7453ff', '#0acf97', '#fa5c7c', '#ffbc00'];
(dataColors = $('#report-chart01').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  annotations: {
    yaxis: [
...
(chart = new ApexCharts(
  document.querySelector('#report-chart01'),
  options
)).render();
...
colors = ['#7453ff', '#0acf97', '#fa5c7c', '#ffbc00'];
(dataColors = $('#report-chart04').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  annotations: {
    yaxis: [
...
(chart = new ApexCharts(
  document.querySelector('#report-chart04'),
  options
)).render();

colors = ['#7453ff', '#0acf97', '#fa5c7c', '#ffbc00'];
(dataColors = $('#report-chart05').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  annotations: {
    yaxis: [
  ...
  series: [
    {
      name: '2주전',
      data: [450, 90, 130, 23, 281, 210, 396],
    },
    {
      name: '지난주',
      data: [22, 48, 140, 72, 244, 41, 450],
    },
  ],
...
(chart = new ApexCharts(
  document.querySelector('#report-chart05'),
  options
)).render();

colors = ['#7453ff', '#0acf97', '#fa5c7c', '#ffbc00'];
(dataColors = $('#report-chart06').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  annotations: {
    yaxis: [
...
(chart = new ApexCharts(
  document.querySelector('#report-chart06'),
  options
)).render();

colors = ['#7453ff', '#0acf97', '#fa5c7c', '#ffbc00'];
(dataColors = $('#report-chart07').data('colors')) &&
  (colors = dataColors.split(','));
options = {
  annotations: {
    yaxis: [
...
(chart = new ApexCharts(
  document.querySelector('#report-chart07'),
  options
)).render();
...
$(document).ready(function () {
  $('#check-result-table').DataTable({
    ...
    drawCallback: function () {
      $('#check-result-table_paginate > .pagination').addClass(
        'pagination-rounded'
      );
    },
  });
  ...
  $('#telehealth-datatable').DataTable({
    ...
    order: [[1, 'desc']],
    drawCallback: function () {
      $('#telehealth-datatable_paginate > .pagination').addClass(
        'pagination-rounded'
      );
    },
  });
  ...
  $('#contents-preview-datatable').DataTable({
    ...
    order: [[1, 'desc']],
    drawCallback: function () {
      $('#contents-preview-datatable_paginate > .pagination').addClass(
        'pagination-rounded'
      );
    },
    ...
    if (!$('#bg-history-modal-table').hasClass('active')) {
      $('#bg-history-modal-table')
        ...
        .DataTable({
          ...
          order: [[0, 'desc']],
          drawCallback: function () {
            $('#bg-history-modal-table_paginate > .pagination').addClass(
              'pagination-rounded'
            );
          },
        });
    ...
    if (!$('#insullin-datatable').hasClass('active')) {
      $('#insullin-datatable')
        ...
        .DataTable({
          ...
          order: [[0, 'desc']],
          drawCallback: function () {
            $('#insullin-datatable_paginate > .pagination').addClass(
              'pagination-rounded'
            );
          },
        });
    ...
    if (!$('#insullin-list-datatable').hasClass('active')) {
      $('#insullin-list-datatable')
        ...
        .DataTable({
          ...
          order: [[0, 'desc']],
          drawCallback: function () {
            $('#insullin-list-datatable_paginate > .pagination').addClass(
              'pagination-rounded'
            );
          },
        });
      ...
      $('#exercise-video-list-datatable')
        ...
        .DataTable({
          ...
          columns: [
            { orderable: 1 },
            { orderable: 1 },
            { orderable: 1, width: '160px' },
            { orderable: 1, width: '320px' },
            { orderable: 1 },
            { orderable: 1 },
          ],
          order: [[0, 'desc']],
          drawCallback: function () {
            $('#exercise-video-list-datatable_paginate > .pagination').addClass(
              'pagination-rounded'
            );
          },
        });
