$(document).ready(function () {
    ...
    $("#auth-datatable").DataTable({
        ...
        language: {
            ...
            sSearch: "검색: <select class=\'form-control d-inline-block w-auto ml-1\'><option >그룹명</option><option ></option><option ></option></select><select class=\'form-control d-inline-block w-auto ml-1\'><option >전체</option><option >미완료</option><option >승인완료</option><option>거절</option></select>",
        ...
        { orderable: !0, width: "220px", render: $.fn.dataTable.render.ellipsis(18, true, true) }, { orderable: !0 }, { orderable: !0 }, { orderable: !0 }, { orderable: !0 }, { orderable: !0 }, { orderable: !0 }, { orderable: !1 }],
        select: { style: "multi" },
        order: [[5, "desc"]],
