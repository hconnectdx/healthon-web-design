			...
			var t = [
					{
						...
						className: 'bg-cal-dim bg-audio',
					},
					{
						title: '최진성',
						start: new Date(2023, 10, 4),
						className: 'bg-cal-dim bg-video',
					},
					{
						title: '최진성',
						start: new Date(2023, 10, 4),
						className: 'bg-cal-success bg-audio',
					},
					{
						title: '최진성',
					...
					},
					{
						title: '최진성',
						start: new Date(2023, 10, 10),
						className: 'bg-cal-warning bg-audio',
					},
					{
						title: '최진성',
						start: new Date(2023, 10, 10),
						className: 'bg-cal-success bg-video',
					},
					{
						title: '최진성',
						start: new Date(2023, 10, 10),
						className: 'bg-cal-info bg-audio',
					},
					{
						title: '이주회',
						start: new Date(2023, 10, 10),
					...
					},
					{
						title: '이주회',
						start: new Date(2023, 10, 8),
						className: 'bg-cal-warning bg-video',
					},
					{
						title: '이주회',
						start: new Date(2023, 10, 8),
					...
					},
					{
						title: '이주회',
						start: new Date(2023, 10, 8),
						className: 'bg-cal-info bg-video',
					},
					{
						title: '이주회',
						start: new Date(2023, 10, 8),
