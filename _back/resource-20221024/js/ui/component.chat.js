!(function (a) {
	...
	(t.prototype.save = function () {
		...
		return "" == t
			...
			: (a(
					'<li class="clearfix odd"><div class="chat-avatar"><img src="resource/images/users/avatar-1.jpg" alt="male"><i>' +
						i +
		...
		(t.prototype.init = function () {
			...
			i.$chatInput.keypress(function (t) {
				...
				i.$chatForm.on("submit", function (t) {
					return t.preventDefault(), i.save(), i.$chatForm.removeClass("was-validated"), i.$chatInput.val(""), !1;
				});
		}),
		(a.ChatApp = new t()),
