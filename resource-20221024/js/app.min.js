!function (a) {
    ...
    t.prototype._reset = function () {
        ...
        var e = this;
        this._reset(), a(".side-nav").metisMenu(), a(document).on("click", ".button-menu-mobile", function (t) {
            t.preventDefault(), e.body.toggleClass("sidebar-enable")
        }), a(".side-nav a").each(function () {
            var t = window.location.href.split(/[?#]/)[0];
            this.href == t && (a(this).addClass("active"), a(this).parent().addClass("mm-active"), a(this).parent().parent().addClass("mm-show"), a(this).parent().parent().prev().addClass("active"), a(this).parent().parent().parent().addClass("mm-active"), a(this).parent().parent().parent().parent().addClass("mm-show"), a(this).parent().parent().parent().parent().parent().addClass("mm-active"), a(this).parent().parent().parent().parent().parent().parent().addClass("mm-show"), a(this).parent().parent().parent().parent().parent().parent().parent().addClass("mm-active"))
        })
    ...
    t.prototype._saveConfig = function (t) {
        ...
        a("#light-style").attr("disabled", !0), a("#dark-style").attr("disabled", !1), a.LeftSidebar.activateDarkTheme(), this._saveConfig({
            isDarkModeEnabled: !0,
            sideBarTheme: o
        })
    ...
    t.prototype.init = function () {
        ...
        o(document).on("click", this.$portletCloser, function (t) {
            t.preventDefault();
            var e = o(this).closest(i.$portletIdentifier), a = e.parent();
    ...
    t.prototype.initSelect2 = function () {
        ...
        n('[data-toggle="input-mask"]').each(function (t, e) {
            var a = n(e).data("maskFormat"), i = n(e).data("reverse");
        ...
        n('[data-toggle="date-picker-range"]').each(function (t, e) {
            var a = n.extend({}, o, n(e).data()), i = a.targetDisplay;
    ...
    t.prototype.initTooltipPlugin = function () {
        ...
        e("[data-password]").on("click", function () {
            "false" == e(this).attr("data-password") ? (e(this).siblings("input").attr("type", "text"), e(this).attr("data-password", "true"), e(this).addClass("show-password")) : (e(this).siblings("input").attr("type", "password"), e(this).attr("data-password", "false"), e(this).removeClass("show-password"))
        })
    ...
    t.prototype.activateDefaultSidebarTheme = function () {
        ...
        window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnStart") && t.showRightSidebarOnStart && (sessionStorage.getItem("_HYPER_VISITED_") || (e.RightBar.toggleRightSideBar(), sessionStorage.setItem("_HYPER_VISITED_", !0))), e.Portlet.init(), e.AdvanceFormApp.init(), e.Components.init(), e(window).on("load", function () {
