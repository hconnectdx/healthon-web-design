$(document).ready(function () {
    ...
    $("#auth-datatable").DataTable({
        ...
        language: {
            ...
            lengthMenu: '<div style="height:32px;" class="d-flex align-items-center cursor"><input type="checkbox" class="mr-1"> 내 담당인 상담만 조회</div>',
            sSearch: "검색: <select class=\'form-control d-inline-block w-auto ml-1\'><option >전체</option><option >작성완료</option><option>미완료</option></select>",
