	...
	$(document).ready(function () {
		...
		$("#survey-select-datatable").DataTable({
			...
			language: {
				...
				sSearch: "검색:",
				lengthMenu:
					'<select class=\'form-control mr-1\'><option value="5">5</option><option value="10">10</option><option value="-1">All</option></select> 개 씩 보기 </a>',
			},
			pageLength: 5,
			columns: [
				{ orderable: !0, width: "80px" },
				{ orderable: !0, width: "33px" },
				{ orderable: !0, width: "60px" },
				{ orderable: !0, width: "10px" },
				{ orderable: !0, width: "25px" },
				{ orderable: !0, width: "40px" },
				{ orderable: !0, width: "10px" },
				{ orderable: !0, width: "30px" },
			],
			drawCallback: function () {
				$(".dataTables_paginate > .pagination").addClass("pagination-rounded");
