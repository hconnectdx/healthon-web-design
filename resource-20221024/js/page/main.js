var colors = ["#7453ff", "#0acf97", "#fa5c7c", "#ffbc00"], dataColors = $("#campaign-sent-chart").data("colors");
...
options = {
    ...
    }, {name: "Total Pipeline", type: "area", data: [12, 21, 28, 42, 36, 40, 53, 42, 58, 61, 75, 89]}],
...
options = {
    ...
    labels: ["80세이상", "70~79세", "60~69세", "50~59세", "40~49세"],
    colors: colors,
