$(document).ready(function () {
    ...
    $("#note-datatable").DataTable({
        ...
        pageLength: 10,
        columns: [{ orderable: !0 }, { orderable: !0, width: "200px" }, { orderable: !0 }, { orderable: !0, width: "600px" }, { orderable: !0, width: "150px" }, { orderable: !0, width: "150px" }, { orderable: !0, width: "220px" }, { orderable: !1, width: "150px" }],
        select: { style: "multi" },
        order: [[0, "desc"]],
        drawCallback: function () {
            ...
            //$("#note-datatable_filter").append("<button class='btn btn-secondary cursor'>검색</button")
        }
    })
});
